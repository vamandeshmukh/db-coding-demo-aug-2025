...
public class TradeController {
    ...
    public ResponseEntity<List<Trade>> searchTradesBySecurityIdentifier(
            @RequestParam String identifier) {
        return ResponseEntity.ok(tradeService.searchTradesBySecurityIdentifier(identifier));
    }

    @GetMapping("/search/issuer")
    public ResponseEntity<List<Trade>> searchTradesByIssuer(
    ...
    public ResponseEntity<List<Trade>> searchTradesByCounterparty(
    ...
    public ResponseEntity<List<Trade>> getBondsForUserBooks(
            @PathVariable String userId) {
        return ResponseEntity.ok(tradeService.getBondsForUserBooks(userId));
    }

    @GetMapping("/{tradeId}")
    public ResponseEntity<Trade> getTradeDetails(
